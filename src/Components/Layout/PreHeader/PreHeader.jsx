...
const PreHeader = () => {
  ...
  const handleLogout = async () => {
    dispatch(logoutUser(null))
      toast.success("logout sussesfull")
      navigate("/")
      localStorage.clear();
          ...
          <div className="pre-header">
            <div className="container">
              <div className="pre-header-content">
                <div className="left-content">{svg1}</div>
                <div className="right-content">
                  <nav className="pre-header-nav">
                    <ul>
                      {user ? (
                        <>
                          <li>
                            <span>Welcome, {user}</span>
                            <span style={{ marginLeft: 13, marginRight: 13 }}>
                              |
                            </span>
                          </li>
                          <li>
                        ...
                        <>
                          <li>
                            <NavLink to="/" className="link-effect">
                              Help
                            </NavLink>
                            <span style={{ marginLeft: 13, marginRight: 13 }}>
                              |
                          ...
                          <li>
                            <NavLink to="/signup" className="link-effect">
                              Sign Up
                            </NavLink>
                            <span style={{ marginLeft: 13, marginRight: 13 }}>
                              |
                          ...
                          <li>
                            <NavLink to="/login" className="link-effect">
                              Login
                            </NavLink>
                            <span style={{ marginLeft: 13, marginRight: 13 }}>
                              |
